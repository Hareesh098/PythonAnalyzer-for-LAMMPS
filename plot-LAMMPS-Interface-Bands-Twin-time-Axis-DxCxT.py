...
ax2.plot(T_subset * Fy, Cx_subset-Cx_subset[0], linewidth=2.0, linestyle='-', color=VxLabelColor, label='$V_{x}$')
...
tight_layout()
FigName = f"../plots/DxCxT-Bands-all-grains-BlockInterface-Fy0.0001-Fx0.00006-TwinXaxis-allDisc"
