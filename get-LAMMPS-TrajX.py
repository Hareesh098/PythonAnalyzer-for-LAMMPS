...
if(len(sys.argv) != 5):
 ...
 print("Usage: ./get-LAMMPS-Gen-TrajX.py filename.dat skip_header max_rows frames")
 sys.exit()
...
xMatrix = []  #List to store x values for each frame
...
xMatrix = array(xMatrix).T
savetxt("../data/xMatrix.dat", xMatrix, delimiter=" ")
